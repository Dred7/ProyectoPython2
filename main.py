...
def main():
    ...
    while True:
        ...
        if opcion == "1":
            ...
            idAgenda = validar_numero_en_rango("Ingrese el ID de la agenda: ", 1, 1)  
            ...
            idTarea = validar_numero_en_rango("Ingrese el ID de la tarea a modificar: ", 1, 999)
            ...
            idTarea = validar_numero_en_rango("ID de la tarea a completar: ", 1, 999)
